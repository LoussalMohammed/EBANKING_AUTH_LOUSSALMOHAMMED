...
import org.roleApp.rollApp.shared.exception.AccessDeniedException;
...
import org.roleApp.rollApp.shared.dto.response.ErrorDTO;
import org.roleApp.rollApp.shared.exception.InvalidRelationshipException;
import org.roleApp.rollApp.shared.exception.ResourceNotFoundException;
import org.roleApp.rollApp.shared.exception.ValidationException;

import java.time.LocalDateTime;
import java.util.stream.Collectors;

import static org.roleApp.rollApp.shared.constant.ErrorCodes.*;
...
public class GlobalExceptionHandler {
    ...
    public ErrorDTO accessDeniedException(AccessDeniedException ade) {
        return new ErrorDTO(
                ade.getMessage(),
                ade.getCause(),
                ade.getErrorCode(),
